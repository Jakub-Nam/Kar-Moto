...
var VehicleListComponent = /** @class */ (function () {
    function VehicleListComponent(vehicleDbService, authService, route) {
    ...
    VehicleListComponent.prototype.deleteVehicle = function () {
    ...
    VehicleListComponent.prototype.showOneVehicle = function (vehicle) {
        this.vehicle = vehicle;
        this.showVehicle = true;
    };
    VehicleListComponent.prototype.hideOneVehicle = function () {
        this.showVehicle = false;
    };
    VehicleListComponent.prototype.hideSuccessAlert = function () {
        this.successMsg = '';
    };
